...
@Table(name = "eam_daliy_rf_collector")
public class DaliyRfCollector extends EnerbosBaseEntity {
    ...
    public DaliyRfCollector() {
    }

    public DaliyRfCollector(String collectId, String type, String personId, String product) {
