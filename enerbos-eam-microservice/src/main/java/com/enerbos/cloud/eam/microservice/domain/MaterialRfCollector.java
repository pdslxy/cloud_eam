...
@Table(name = "eam_material_rf_collector")
public class MaterialRfCollector extends EnerbosBaseEntity {
    ...
    public MaterialRfCollector() {
    }

    public MaterialRfCollector(String collectId, String type, String personId, String product) {
